...
export const WEB_RUNTIME_CAPABILITIES = [
  ...
  PI_WEB_CAPABILITIES.sessionsSummarySnapshot,
  PI_WEB_CAPABILITIES.sessionsRename,
...
const EFFECTIVE_CAPABILITY_REQUIREMENTS = {
  ...
  [PI_WEB_CAPABILITIES.sessionsSummarySnapshot]: ["web", "sessiond"],
  [PI_WEB_CAPABILITIES.sessionsRename]: ["web", "sessiond"],
